...
import { WorkingRecordDetailsComponent } from './working-record-details/working-record-details.component';

@NgModule({
    declarations: [AppComponent, WorkingRecordsComponent, WorkingRecordDetailsComponent],
    imports: [
